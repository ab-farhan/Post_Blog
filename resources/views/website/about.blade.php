            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 order-md-2">
                        <img src="{{asset('contents/website')}}/assets/images/img_1.jpg" alt="Image" class="img-fluid">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 mb-5 text-center">
                        <img src="{{asset('contents/website')}}/assets/images/person_1.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 text-center">
                        <img src="{{asset('contents/website')}}/assets/images/person_2.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 text-center">
                        <img src="{{asset('contents/website')}}/assets/images/person_3.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
